...
export const iconRailHomeButton = document.querySelector("#icon-rail-home");
...
export const projectsToolbar = document.querySelector("#projects-toolbar");
export const projectsCreateButton = document.querySelector("#projects-create-button");
